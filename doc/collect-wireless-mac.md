...
Run this script from a dhcp server as lease-script to collect the MAC address when a new address is leased. You may want to use [lease-script](lease-script.md).
...
[◀ Go back to main README](../)  
[▲ Go back to top](collect-wireless-mac.md#top)
